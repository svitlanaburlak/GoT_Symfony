 ...
 */
final class Version20220904100824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `character` (id INT AUTO_INCREMENT NOT NULL, title_id INT DEFAULT NULL, father_id INT DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, biography LONGTEXT NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, mother_id INT DEFAULT NULL, INDEX IDX_937AB034A9F87BD (title_id), INDEX IDX_937AB03492BBFC94 (father_id), INDEX IDX_937AB03492BBFC95 (mother_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `character` ADD CONSTRAINT FK_937AB03492BBFC94 FOREIGN KEY (father_id) REFERENCES `character` (id)');
        $this->addSql('ALTER TABLE `character` ADD CONSTRAINT FK_937AB03492BBFC95 FOREIGN KEY (mother_id) REFERENCES `character` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `character` DROP FOREIGN KEY FK_937AB03492BBFC94');
        $this->addSql('ALTER TABLE `character` DROP FOREIGN KEY FK_937AB03492BBFC95');
